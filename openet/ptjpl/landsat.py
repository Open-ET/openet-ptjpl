...
def emissivity_metric(toa_image):
    ...
    return lai_img.divide(300).add(0.97) \
...
def mndwi(landsat_image):
    ...
    return ee.Image(landsat_image).normalizedDifference(['green', 'swir2']) \
        .rename(['mndwi'])
